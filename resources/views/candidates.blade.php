    ...
    <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">
        <div class="flex w-full items-center justify-between border-b pb-3">
            <div class="flex items-center space-x-3">
                ...
                <div class="text-lg font-bold text-slate-700">Joe Smith | <span
                        class="text-xs text-neutral-500">test@mail.com</span></div>
            </div>
        ...
        <div class="mt-4 mb-6">
            <div class="mb-3 text-xl font-bold">Nulla sed leo tempus, feugiat velit vel, rhoncus neque?
            </div>
